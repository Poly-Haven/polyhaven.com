  ...
  return (
    ...
    >
      <div dir="ltr" style={{ textAlign: 'left' }}>
        ...
        <p>
          Our assets are used by people all around the world - in fact more than half our users don't choose English as
          their first language!
        </p>
        <p>
          If you'd like to help us translate the site into other languages, please reach out to us on{' '}
          <a href="https://discord.gg/Dms7Mrs">Discord</a> or by <Link href="/about-contact">email</Link>.
        </p>
        <div
          style={{
            display: 'flex',
        ...
        <p>
          The service we use for translations (<a href="https://i18nexus.com/">i18nexus</a>) automatically translates
          strings by default using Google Translate, which is a good start, but requires manual review and corrections.
        </p>

        <p>
          The basic workflow is thus to go through the list of strings and confirm or tweak the existing automatic
          translations.
        </p>

        <p>
          All strings have either an attached screenshot or a desciption (in the left most column) to provide some
        ...
        <h3>Proper Nouns</h3>
        <p>
          Make sure that the names of websites, software, and people are not translated, such as "Poly Haven",
          "Discord", "Patreon", etc.
        </p>
        ...
        <h3>{'{{variables}}'}</h3>
        <p>
          When you see a set of double brackets, like {'{{this}}'}, this indicates a variable that will be replaced by a
          value on the site.
        </p>
        <p>
          Make sure that sentence structure is maintained, but don't edit the text inside the brackets ("count" in this
          example).
        </p>
        <p>For example:</p>
        ...
        <p>
          You can edit what's between the opening and closing tags, and fix sentence structure, but don't edit the tag
          name itself.
        </p>
        ...
        <p>
          The database of translations is automatically filled with translations from Google Translate. This provides a
          good start, but it usually breaks formatting of tags and smileys.
        </p>
        <p>For example:</p>
        <q>This is a sentence with a {`<lnk>link</lnk>`}, and then a smiley :) Thanks!</q>
        <p>Which is auto-translated to:</p>
        <q>
          Esta es una oración con un<span className="text-red">{`<lnk>`}</span> enlace{`</lnk>`} y luego un emoticón
          <span className="text-red">: )</span> ¡Gracias!
        </q>
        <p>But it should be:</p>
        <q>
          Esta es una oración con un <span className="text-green">{`<lnk>`}</span>enlace{`</lnk>`} y luego un emoticón{' '}
