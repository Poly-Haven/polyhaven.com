...
const Popularity = ({ data }) => {
      ...
      <div className={styles.tableWrapper}><table>
        ...
        {popData.textures.map((pop, i) => <tr>
          ...
          <td>
            ...
            {pop.warning ? <abbr title='This texture is less than 28 days old, popularity has not yet stabilized.'>
  ...
  return (
    <div className={styles.wrapper}>
      ...
      <p>This page shows the popularity rating of textures published in {new Date(month).toLocaleString('en-us', { month: 'long' })} {month.split('-')[0]}.</p>

      <p>The popularity rating* is used to determine the bonus earnings for the author of each texture. More popular textures earn the author more income (on top of the base rate).</p>
      ...
      <div className={styles.footnotes}>
        <p>
          * Popularity rating is determined by unique downloads over the first 28 days of the texture's publication, with some basic statistical maniplulation to lower the influence of large spikes and troughs in downloads.<br />
          This is to account for inconsistent social media influence, public holidays, and server instabilities, and thus attempt to provide a fairer comparison of quality and usefulness.<br />
