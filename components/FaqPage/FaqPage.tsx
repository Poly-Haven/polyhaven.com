  ...
  return (
    <div>
      ...
      <FaqItem question={t('faq:q01')} activeQ={clicked} qID="commercial">
        <p>
          <Trans i18nKey="faq:q01p1" t={t} components={{ lnk: <LinkText href="/license" /> }} />
        </p>
      </FaqItem>
      ...
      <FaqItem question={t('faq:q06')} activeQ={clicked} qID="use-hdri">
        ...
        <ol>
          <li>
            <a href="https://www.youtube.com/watch?v=Pi4Ft7M8UOU">Blender + Cycles</a>
          </li>
          <li>
            <a href="https://www.youtube.com/watch?v=riBa2YWfajc">3ds Max + Corona</a>
          </li>
        </ol>
        <p>{t('faq:q06p2')}</p>
      </FaqItem>
